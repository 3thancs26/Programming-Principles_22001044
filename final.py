...
class ClassroomManagementSystem:
        ...
        while True:
            ...
            if student_code == generated_code:
                ...
                if student_id in student_data:
                    ...
                    weekday = datetime.now().strftime('%A') # %A displays only weekday
    ...
    def calculate_attendance(self, student_id, subject_code):
        ...
        return attendance_percentage # Total attendance percentage is calculated
    ...
    def manage_attendance(self):
        # Main menu for attendance tasks
        while True:
    ...
    def create_timetable_teacher(self):
        # For teachers to create timetables
    ...
    def update_timetable_teacher(self):
        # For teachers to update the timetable
        teacher_username = 'eduhub'
        teacher_password = 'eduhub'
        entered_username = input("Please enter your username: ")
        entered_password = input("Please enter your password: ")
    ...
    def delete_timetable_teacher(self):
        # For teachers to delete timetable
        teacher_username = 'eduhub'
        teacher_password = 'eduhub'
        entered_username = input("Please enter your username: ")
        entered_password = input("Please enter your password: ")
    ...
    def read_timetable_student(self):
        # For students to view the timetable
    ...
    def manage_timetable(self):
        # Main menu for teachers to edit course timetable
        while True:
    ...
    def display_assignment_statuses(self):
        ...
        print("{:<15} {:<15} {:<25} {:<15} {:<20}".format("Student ID", "Course Code", "Assignment Name", "Status", "Submission Date")) # inputs formatted to a tidy manner
        try:
            with open(self.assignment_file, "r") as file:
                for line in file:
                    try:
    ...
    def readme(self): # Detailed explanation of the system
        def center_bold_italic(text):
            return f"\033[1m{text}\033[0m" # ANSI escape code to bold text for clearity
...
def main():
    ...
    while True: # ANSI escape code is used to format messages
