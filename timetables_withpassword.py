def create_timetable_teacher():
    ...
    if entered_username != teacher_username or entered_password != teacher_password:
        print("Authentication failed. Only teachers are allowed to create timetables.")
        return
...
def update_timetable_teacher():
    # Implement teacher authentication here
    # For simplicity, let's assume a hardcoded teacher username and password
    teacher_username = "teacher"
    teacher_password = "password"
    entered_username = input("Please enter your username: ")
    entered_password = input("Please enter your password: ")
    if entered_username != teacher_username or entered_password != teacher_password:
        print("Authentication failed. Only teachers are allowed to update timetables.")
        return
    
    # Proceed with timetable update
    subject_code = input("Please enter subject code: ")
    subject_name = input("Please enter subject name: ")
    instructor = input("Please enter your subject instructor: ")
    room = input("Please enter the classroom number: ")
...
def delete_timetable_teacher():
    teacher_username = "teacher"
    teacher_password = "password"
    entered_username = input("Please enter your username: ")
    entered_password = input("Please enter your password: ")
    if entered_username != teacher_username or entered_password != teacher_password:
        print("Authentication failed. Only teachers are allowed to delete timetables.")
        return
...
def main():
    while True:
        print("[1] Create course timetable (Teacher)")
        print("[2] Update course timetable (Teacher)")
        print("[3] Delete course timetable (Teacher)")
        print("[4] Read course timetable (Student)")
        print("[5] Exit")
        selection = input("Please select 1, 2, 3, 4, or 5: ")
        
        if selection == "1":
            create_timetable_teacher()
        elif selection == "2":
            update_timetable_teacher()
        elif selection == "3":
            delete_timetable_teacher()
        elif selection == "4":
            read_timetable_student()
        elif selection == "5":
            print("Exiting...")
            break
        else:
